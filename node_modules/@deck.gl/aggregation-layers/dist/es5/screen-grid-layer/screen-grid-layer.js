...
var _gpuGridAggregatorConstants = require("../utils/gpu-grid-aggregation/gpu-grid-aggregator-constants");
...
var ScreenGridLayer = function (_Layer) {
  (0, _inherits2.default)(ScreenGridLayer, _Layer);
  ...
  (0, _createClass2.default)(ScreenGridLayer, [{
    ...
    value: function getShaders() {
      var shaders = (0, _core2.isWebGL2)(this.context.gl) ? {
    ...
    value: function getPickingInfo(_ref5) {
      ...
      if (index >= 0) {
        var aggregationResults = this.state.aggregationResults;
        ...
        var aggregationData = aggregationResults.aggregationData,
            maxData = aggregationResults.maxData;
    ...
    value: function _updateAggregation(changeFlags) {
      ...
      weights.color.operation = _gpuGridAggregatorConstants.AGGREGATION_OPERATION[this.props.aggregation.toUpperCase()] || _gpuGridAggregatorConstants.AGGREGATION_OPERATION.SUM;
    ...
    value: function _updateGridParams() {
      ...
      aggregationBuffer = new _core2.Buffer(gl, {
